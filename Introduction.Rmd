...
insert cool graph with code here.
...
But we are all likely a long way off from there. The best place to start is to go through some fantastic resources developed by a guy called [Hadley Wickham](http://hadley.nz/). He is one of the core developers for RStudio and has spearheaded the development of many of the packages we will be using today. He has written a book called [R for Data Science](http://r4ds.had.co.nz/) which is absolutely fantastic! Much of what I have learnt started there.
